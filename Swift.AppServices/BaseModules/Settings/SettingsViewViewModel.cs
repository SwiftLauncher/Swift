...
namespace Swift.AppServices.BaseModules
{
    ...
    public class SettingsViewViewModel : ViewModelBase, IInitializationAware, IPluginServiceUser
    {
        ...
        {
            _pluginServices.GetService<IUIService>().AddUIResource(new Uri("pack://application:,,,/Swift.AppServices;component/BaseModules/Settings/SettingsViewTemplates.xaml", UriKind.Absolute));
