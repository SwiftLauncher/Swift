...
namespace Swift.AppServices.BaseModules
{
    ...
    public class TopBarViewModel : ViewModelBase, IInitializationAware, IPluginServiceUser
    {
        ...
        {
            _pluginServices.GetService<IUIService>().AddUIResource(new Uri("pack://application:,,,/Swift.AppServices;component/BaseModules/TopBar/TopBarTemplates.xaml", UriKind.Absolute));
